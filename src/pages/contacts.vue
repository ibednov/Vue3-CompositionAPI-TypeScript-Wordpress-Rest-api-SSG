  ...
  >
    ...
    >
      ...
      <div class="flex flex-col md:flex-row md:flex-wrap gap-4 py-4">
        <a
          href="https://www.instagram.com/ibednov/"
          target="_blank"
          type="button"
        ...
        <a
          href="https://www.behance.net/alepsios"
          target="_blank"
          type="button"
        ...
        <!-- <a href="https://wa.me/qr/JYZOKXUAOVAPP1" target="_blank" type="button"
                    class="flex flex-row gap-4 justify-center content-center text-white dark:text-black bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-xl text-sm px-5 py-5 text-center mr-2 mb-2">
                    <div>

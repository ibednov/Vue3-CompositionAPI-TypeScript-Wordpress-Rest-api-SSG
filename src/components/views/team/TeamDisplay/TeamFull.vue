    ...
    <article>
        ...
        <section class="container mx-auto flex flex-col py-12">
          ...
          <div class="flex flex-col gap-y-8 sm:flex-row flex-wrap py-10">
            ...
            >
              <div v-show="lang === 'ru'" class="flex flex-col gap-2">
              ...
              <div v-show="lang === 'en'" class="flex flex-col gap-2">
                <div class="text-xl font-bold uppercase self-center">
          ...
          <div class="flex flex-col flex-wrap py-10">
            ...
            >
              ...
              >
                ...
                <div v-show="lang === 'ru'" class="text-lg font-light">
                  {{ edu.education_place }}
                </div>
                <div v-show="lang === 'en'" class="text-lg font-light">

    ...
    <div class="container mx-auto pb-10">
      ...
      >
        <div class="flex flex-col py-4 gap-y-4 gap-x-8">
          ...
          <!-- project theory -->
          <div v-if="!(page.categories[0] === 2)">
            <div
              v-if="
                page.acf.project_year ||
                page.acf.project_client ||
                page.acf.project_purpose
              "
          ...
          <div v-if="!(page.categories[0] === 2)">
            <div
              v-if="page.acf.project_stack || page.acf.project_team"
              class="flex flex-col md:flex-row gap-8 justify-start"
            >
              <div
          ...
          <div v-if="!(page.categories[0] === 2)">
            <div
              v-if="page.acf.project_behance || page.acf.project_link"
              class="flex flex-col md:flex-row gap-8 justify-start"
            >
              <div

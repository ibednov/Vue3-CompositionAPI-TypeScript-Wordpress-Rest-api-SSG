...
<template>
  <div class="flex items-center md:order-2">
    <button
      ...
      type="button"
      data-dropdown-toggle="language-dropdown-menu-ru"
    ...
    <button
      ...
      type="button"
      data-dropdown-toggle="language-dropdown-menu-en"
      class="inline-flex justify-center items-center p-2 text-sm text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
    >
      <svg
        id="flag-icon-css-ru"
    ...
    <div
      ...
      style="
        ...
        margin: 0px;
        transform: translate(0px, 12653px);
      "
    >
